...
export const Footer = () => {
  return (
    <footer className="bg-background text-foreground py-20 px-4 sm:px-6 relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="absolute bottom-0 left-0 w-full h-1/2"></div>
        <div className="absolute top-1/3 right-0 w-64 h-64 bg-purple-600 rounded-full mix-blend-soft-light filter blur-3xl opacity-10 dark:opacity-5"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex space-x-3 sm:space-x-4">
            {[
              ...
              <a
                ...
                className="bg-[var(--card-background)] p-2.5 rounded-full hover:bg-[var(--card-softBackground)] transition-all duration-300 hover:scale-110 border border-[var(--card-border)] hover:border-purple-400/30"
              >
                <span className="text-purple-500 dark:text-purple-400">{social.icon}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-2">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-purple-500/20">
          ...
          {/* Learn Section */}
          <div>
            <h3 className="text-lg font-semibold mb-5 text-foreground relative inline-flex items-center group">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center text-muted-foreground hover:text-foreground transition-colors duration-200 group">
                <div className="p-2 rounded-full bg-[var(--card-background)] mr-3 group-hover:bg-[var(--card-softBackground)] transition-colors duration-300 border border-[var(--card-border)] group-hover:border-purple-600/30">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
              {["Privacy Policy", "Terms of Service", "Cookies"].map((item) => (
                <a
                  key={item}
                  href="#"
                  className="text-xs text-muted-foreground hover:text-purple-300 transition-colors duration-200"
                >
                  {item}
                </a>
              ))}
