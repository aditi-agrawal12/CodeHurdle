  ...
  return (
    <ProgressProvider>
      <div className="flex h-screen bg-background text-foreground overflow-hidden">
        {/* Mobile toggle button */}
        <button
          className="md:hidden fixed top-6 left-4 z-[100] p-2 bg-muted border border-border rounded-lg"
          onClick={() => setIsSidebarOpen(!isSidebarOpen)}
        >
        ...
        {/* Sidebar */}
        <div
          className={`fixed md:static z-40 w-64 h-full border-r transition-all duration-300
